package com.example.ashwin.customedittextwidget.widgets;
...
import com.example.ashwin.customedittextwidget.R;
...
public class ClearableEditText extends FrameLayout {
    ...
    private boolean mShowClearButton, mPasswordToggleEnabled;
    ...
    public ClearableEditText(Context context, AttributeSet attrs) {
        ...
        try {
            for (int i = 0; i < count; ++i) {
                ...
                } else if (attr == R.styleable.ClearableEditText_showClearButton) {
                    mShowClearButton = typedArray.getBoolean(attr, false);
                    setClearButtonEnabled(mShowClearButton);
                } else if (attr == R.styleable.ClearableEditText_passwordToggleEnabled) {
                    mPasswordToggleEnabled = typedArray.getBoolean(attr, false);
    ...
    public void setClearButtonEnabled(boolean showClearButton) {
        if (showClearButton) {
    ...
    public void setPasswordToggleEnabled(boolean passwordToggleEnabled) {
        mTextInputLayout.setPasswordVisibilityToggleEnabled(passwordToggleEnabled);
        mAutoCompleteTextView.setTransformationMethod(PasswordTransformationMethod.getInstance());
    }
